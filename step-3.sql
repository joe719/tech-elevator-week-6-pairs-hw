...
select reservation_id, site_id, name, from_date, to_date from reservation where from_date >= '2020-10-01' and to_date <= '2020-10-31';
...
select from_date, count(from_date) from reservation group by from_date order by count(from_date) asc;
